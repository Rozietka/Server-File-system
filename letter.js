 ...
 * @param {number} position {number} Simbolio pozicija (programuojojiska). `Default = 0`. 
 * @returns {[boolean, string]} Funkcijos klaidos statusas, Funkcijos 
 * rezultatas (klaidos pranesimas arba simbolis)
 */
